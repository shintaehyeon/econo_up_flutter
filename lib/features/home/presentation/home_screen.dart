...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildCurrentTabBody() {
    ...
    if (_homeError != null) {
      return Center(child: Text('에러가 발생했습니다:\n$_homeError', textAlign: TextAlign.center));
    }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '${_home?.nickname ?? widget.nickname} 님, 환영해요!',
